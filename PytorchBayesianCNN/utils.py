...
def save_array_to_file(numpy_array, filename, array_type, BNN_record_cfg):
    file = open(filename, 'a')
    shape = " ".join(map(str, numpy_array.shape))
    file.write(f"{array_type}${shape}${BNN_record_cfg['curr_batch_no']}${BNN_record_cfg['curr_epoch_no']}\n")
